...
class OrderDB {
    ...
    init?(tableNumber: Int, identifier: String, price: String, userId: String){
    ...
    func convertToDictionary() -> Any {
        return ["table": tableNumber, "isDone": isDone, "identifier": identifier, "price": price, "userId": userId]
    }
}
